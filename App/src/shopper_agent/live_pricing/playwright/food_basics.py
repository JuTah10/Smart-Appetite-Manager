...
_SEARCH_URL = "https://www.foodbasics.ca/search"
_PRODUCT_URL = "https://www.foodbasics.ca/product/{product_id}"
_STORE_NAME = "Food Basics"


async def get_food_basics_prices(
    query: str,
    max_results: int = 50,
    tool_context: Optional[Any] = None,
    tool_config: Optional[Dict[str, Any]] = None,
) -> Dict[str, Any]:
    """Fetch live shelf prices from Food Basics using headless Playwright.

    Food Basics uses the same Metro Inc. platform, so the DOM structure
